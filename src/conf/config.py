...
class Config:
    ...
    JWT_SECRET = JWT_SECRET # Secret key for tokens
    JWT_ALGORITHM = JWT_ALGORITHM # Token encryption algorithm
    JWT_EXPIRATION_SECONDS = int(JWT_EXPIRATION_SECONDS) # Token validity period
